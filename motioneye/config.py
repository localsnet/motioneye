...
def netcam_usepass_params(v, data):
    return {'netcam_params': v}
...
_MOTION_43_TO_44_OPTIONS_MAPPING = {
    ...
    'netcam_url': netcam_url_params,
    'netcam_use_tcp': netcam_use_tcp_params,
    'netcam_userpass': netcam_usepass_params,
